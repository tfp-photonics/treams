...
def translate(
    ...
    Args:
        ...
        material (:class:`~ptsa.Material` or tuple, optional): Material parameters.
        modetype (str, optional): Wave mode, only used for
        :class:`~ptsa.PlaneWaveBasisPartial`.
...
def expand(
    ...
    Args:
        ...
        modetype (str, optional): Wave mode, used for
            :class:`~ptsa.SphericalWaveBasis` and :class:`CylindricalWaveBasis`.
        k0 (float, optional): Wave number.
        material (:class:`~ptsa.Material` or tuple, optional): Material parameters.
        poltype (str, optional): Polarization, see also
            :ref:`polarizations:Polarizations`.
...
def expandlattice(
    ...
    *,
    ...
    Args:
        lattice (:class:`~ptsa.Lattice` or array-like, optional): Lattice definition. In
            some cases this argument can be omitted, when the lattice can be inferred
            from the basis.
...
def efield(r, *, basis, k0=None, material=Material(), modetype=None, poltype=None):
    ...
    Args:
        ...
        basis (:class:`~ptsa.BasisSet`): Basis set.
        k0 (float, optional): Wave number.
        material (:class:`~ptsa.Material` or tuple, optional): Material parameters.
