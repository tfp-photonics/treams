...
def translate(kz, mu, pol, qz, m, qol, krr, phi, z, singular=True, *args, **kwargs):
    ...
    Returns the correct translation coefficient from :func:`ptsa.special.tl_vcw` and
    :func:`ptsa.special.tl_vcw_r` or a combination thereof for the specified mode. A
